          ...
          >
            {onAssign && assignablePeople.length > 0 && (
              <div className="relative">
                ...
                {showAssignSubmenu && (
                  <div role="menu" aria-label="Personas disponibles" className="absolute right-full top-0 mr-1 w-48 bg-card border border-border rounded-xl shadow-xl z-[9999] py-1 animate-in fade-in slide-in-from-left-2 duration-150" onClick={(e) => e.stopPropagation()}>
                    {assignedToProfile && (
