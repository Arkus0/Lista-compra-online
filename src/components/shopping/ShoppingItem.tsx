    ...
    <>
      ...
      >
        ...
        <div className="relative" ref={menuRef}>
          ...
          {showActionMenu && (
            <div className="absolute top-full right-0 mt-1 w-52 bg-card border border-border rounded-xl shadow-xl z-[9999] py-1 animate-in fade-in slide-in-from-top-2 duration-150">
